...
public class Carrinho {
    ...
    public Carrinho(int codigo, float valorTotal, String formaPgto, Date data, String formaEntrega, int codigoIC,
            float valorIC, int qtdeIC) {
    ...
    public String toString() {
        ...
        return " Código: " + this.codigo + " Valor total: " + this.valorTotal + " Pagto: " + this.formaPgto + " Data: "
                + this.data + " Entrega: " + this.formaEntrega + " \n Item Carrinho: " + this.itemCarrinho.toString();
